...
/**
 * Create an OpenRouter provider with fallback resolution.
 * Resolves apiKey from: provided value → OPENAI_API_KEY → OPENROUTER_API_KEY
 * Resolves baseURL from: provided value → OPENAI_BASE_URL → DEFAULT_BASE_URL
